    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        week_view_foo.setLessonClickListener {
            if(it.event.title.equals("Yöneylem")){
                ...
                val bundle = Bundle()
                bundle.putString("lessonName", it.event.title)
                AbsenceScreenFragment().setArguments(bundle)
                fragmentTransaction.replace(R.id.frame_layout,AbsenceScreenFragment()).commit()
            }
        }
